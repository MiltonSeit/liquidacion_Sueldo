...
def Alta_Docente():
	...
	#lblObra= Label(medio,text="Obra Social", font=("Time", 15)).place(x=50, y=330)
	...
	#entra_obra = StringVar()

	#obra=Entry(medio, textvariable=entra_obra, font=("Arial", 13)).place(x=200, y= 330)
